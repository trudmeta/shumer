            ...
            if (!empty($post_ajax)) { ?>
                <div class="section-offer" data-service="apartment">
                    <div class="selectors-container">
                        <p class="selector active" data-target="#offer-wireless-ajax">Беспроводной комплект AJAX</p>
                    </div>
                    <div id="offer-wireless-ajax" class="offer-container row active" data-target="Беспроводной комплект AJAX">
                        <div class="equipment-container eight dfd_col-tabletop-7 dfd_col-laptop-7 dfd_col-mobile-12 columns animated fadeInLeft">
                            <div class="equipment-wrapper">
                                <div class="eq-header"><p>Базовый комплект беспроводной AJAX</p></div>
                            ...
                            <div class="equipment-wrapper additional-equipment">
                                <div class="eq-header">
                                    <p>Дополнительное оборудование</p>
                                    <span class="eq-header-color">Цвет</span>
                                    <i class="fas fa-chevron-up switch-calc close-calc"></i>
                                </div>

                                <div class="eq-container">

                                    <?php foreach ($post_ajax as $ajax) { ?>
                                        <?php if (!(int)$ajax['basic_kit']) { ?>
                                            <div class="eq-row" data-id="<?php echo $ajax['ID']; ?>">

                                                <div class="eq-image">
                                                    <img class="black active" src="<?php echo($ajax['imgsrc']); ?>" alt="">
                                                    <?php
                                                    if(isset($ajax['img_whitesrc'])){?>
                                                        <img class="white" src="<?php echo($ajax['img_whitesrc']); ?>" alt="">
                                                    <?php } ?>
                                                </div>
                                                <div class="eq-title">
                                                    <p><?php echo $ajax['post_title']; ?></p>
                                                ...
                                                <div class="eq-price">
                                                    <p class="price-container"><span class="eq-item-price"><?php echo $ajax['price']; ?></span> <span>грн</span></p>
                                                </div>
                                                <div class="eq-color">
                                                    <div class="eq-color-item white" data-color="white"><span></span></div>
                                                    <div class="eq-color-item black" data-color="black"><span></span></div>
                                                </div>
                                                <div class="eq-calc">
                                                    <i class="dfd-socicon-angle-pointing-to-left minus-item"></i>
                                                    <p class="eq-quantity-container">0</p>
                                                    <i class="dfd-socicon-angle-arrow-pointing-to-right plus-item"></i>
                                                </div>
                                                <div class="eq-switch">
                                                    <div class="eq-switcher add-item"><span></span></div>
                                                </div>
                                                <div class="eq-info">
                                                    <i class="dfd-socicon-information-button"></i>
                                                    <div class="info-container animated fadeInUp">
                        ...
                        <div class="summary-container four dfd_col-tabletop-5 dfd_col-laptop-5 dfd_col-mobile-12 columns animated fadeInRight">
                            <div class="summary sticky-summary">
                                ...
                                <div class="total-summary animated fadeIn" style="display: none;">
                                    ...
                                    <div class="summary-row equipment-price">
                                        <p class="item-title">Стоимость оборудования</p>
                                        <p class="item-value"><span class="price-container total-price">5799</span> грн</p>
                                    </div>
                                    <div class="summary-row">
                                        <p class="item-title">Абонентская плата</p>
                                        <p class="item-value"><span>300</span> грн/месяц</p>
                                    </div>
                                </div>
...
add_action( 'wp_enqueue_scripts', 'equp_func',999 );