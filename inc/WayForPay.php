...
class WayForPay
{
    ...
    public static function factory($merchant_account, $merchant_password, $charset = self::DEFAULT_CHARSET) {
        return new WayForPay($merchant_account, $merchant_password, $charset = self::DEFAULT_CHARSET);
    }
    ...
    public function buildForm($fields)
    {
        ...
        $form = sprintf('<form method="POST" id="wayforpay" style="display:none" action="%s" accept-charset="utf-8">', self::PURCHASE_URL);
